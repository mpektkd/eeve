...
date_end = '2021-3-05 02:49:28.00+00:00'
...
with open('data_file.csv', 'w', newline='') as file:
    ...
    for i in range(number_of_sessions):
        ...
        point = random.choice(station.points.all())
        ...
        c = datetime(b.year, b.month, b.day, b.hour+(int(rand()*10)), b.minute+(int(rand()*10)), b.second+(int(rand()*10)), b.microsecond+(int(rand()*10)))
        c = c.strftime("%Y-%m-%d %H:%M:%S.00+00:00")
        doneCharginTime = c[:]
